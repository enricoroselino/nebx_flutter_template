...
import 'package:nebx_flutter_template/infrastructure/services/biometric_impl.dart';
import 'package:nebx_flutter_template/infrastructure/services/logger_impl.dart';
import 'package:nebx_flutter_template/infrastructure/services/secure_storage_impl.dart';
...
class SetupDependencies {
  ...
  static init() async {
    ...
    loc.registerSingleton<ISecureStorage>(SecureStorageImpl());
    loc.registerSingleton<IBiometric>(BiometricImpl());
